...
export default function Sidebar({ isOpen, closeSidebar }) {
    return (
        <>
            ...
            <aside
                className={`fixed top-0 left-0 z-50 w-64 h-full bg-white dark:bg-gray-800 shadow-md border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-200 sm:translate-x-0
            ...
            >
                <div className="p-4 flex flex-col h-full">
                    ...
                    <nav className="flex flex-col gap-2">
                        ...
                        <SideLink to="/articles" label="Articles" />
